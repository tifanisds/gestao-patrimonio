...
@section('title', 'Categorias - Gestão de Patrimônio')
...
@section('content')
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Categorias</h1>
            <p class="text-gray-600 dark:text-gray-400">Gerenciar todas as categorias de patrimônio</p>
        </div>
        <div class="mt-4 md:mt-0">
            <a href="{{ route('categorias.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-900 dark:bg-blue-700 text-white rounded-lg hover:bg-blue-800 dark:hover:bg-blue-600 transition-colors duration-200 font-medium">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" placeholder="Nome da categoria..." class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-900 dark:focus:ring-blue-400">
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Lista de Categorias</h2>
        </div>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($categorias as $categoria)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150">
                            <td class="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">{{ $categoria->nome ?? 'Categoria' }}</td>
                            <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{{ Str::limit($categoria->descricao ?? 'Sem descrição', 60) }}</td>
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('categorias.show', $categoria) }}" class="inline-flex items-center gap-1 px-3 py-1 text-sm text-blue-900 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded transition-colors duration-200">
                                    ...
                                    <a href="{{ route('categorias.edit', $categoria) }}" class="inline-flex items-center gap-1 px-3 py-1 text-sm text-amber-900 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 rounded transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <tr>
                            <td colspan="3" class="px-6 py-8 text-center text-gray-500 dark:text-gray-400">
                                <div class="flex flex-col items-center justify-center gap-2">
                                    ...
                                    <a href="{{ route('categorias.create') }}" class="text-blue-900 dark:text-blue-400 hover:underline mt-2">Cadastre a primeira agora</a>
                                </div>
                            </td>
                        </tr>
                    @endforelse
